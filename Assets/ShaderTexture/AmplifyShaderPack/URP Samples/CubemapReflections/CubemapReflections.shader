...
Shader "AmplifyShaderPack/URP/CubemapReflections"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Normals("Normals", 2D) = "bump" {}
		_Cubemap("Cubemap", CUBE) = "white" {}
		_Metallic("Metallic", Range( 0 , 1)) = 0
		_Smoothness("Smoothness", Range( 0 , 1)) = 0
		[ASEEnd]_BaseColor("Base Color", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Albedo = ( _BaseColor * 0.5 ).rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;1228.669;403.6194;1.408858;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-161.048,391.5903;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0.7647059;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-640,256;Inherit;True;Property;_Cubemap;Cubemap;1;0;Create;True;0;0;0;False;0;False;-1;None;784d8a7d322a43baa027462fbd81f226;True;0;False;white;Auto;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;1;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;29;-198.1195,276.8774;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F6C272122D1998A9C094304EE65746CEEB15D165