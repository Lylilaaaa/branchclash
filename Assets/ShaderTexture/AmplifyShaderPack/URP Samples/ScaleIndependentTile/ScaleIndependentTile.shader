...
Shader "AmplifyShaderPack/URP/ScaleIndependentTile"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_TilingScale("Tiling Scale", Vector) = (1,1,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Albedo = tex2D( _Albedo, texCoord15 ).rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;335.0546;350.2899;1;True;False
...
ASEEND*/
//CHKSM=F287E6B84AE150ABBA3254AD6FEE7F4342839417