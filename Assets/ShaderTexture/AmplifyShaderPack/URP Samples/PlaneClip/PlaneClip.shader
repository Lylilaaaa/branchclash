...
Shader "AmplifyShaderPack/URP/PlaneClip"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_CutoffColor("CutoffColor", Color) = (0,0,0,0)
		...
		[ASEEnd]_Smoothness("Smoothness", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float3 Albedo = ( scaledFace15 * tex2D( _Textured_Course_AlbedoTransparency, uv_Textured_Course_AlbedoTransparency ) ).rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;780.2759;524.6097;1.817222;True;False
...
Node;AmplifyShaderEditor.SamplerNode;30;-681.6594,-815.6607;Inherit;True;Property;_Textured_Course_AlbedoTransparency;Textured_Course_AlbedoTransparency;3;0;Create;True;0;0;0;False;0;False;-1;None;359c4962c0a3407eb969c1d9eeb6426b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=FF624AC94C7A013528E17381F126DBF60D15D1F1