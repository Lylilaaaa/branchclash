...
Shader "AmplifyShaderPack/URP/2D Fractal"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_MaxIter("MaxIter", Int) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( _Tint * float4( hsvTorgb23 , 0.0 ) ).rgb;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-275.6788;672.2167;1.388562;True;False
...
Node;AmplifyShaderEditor.ColorNode;50;1209.487,-624.3115;Inherit;False;Property;_Tint;Tint;6;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;1464.982,-488.2322;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D3DBFC1E34CC9C86436540790B25858C179DDDF8