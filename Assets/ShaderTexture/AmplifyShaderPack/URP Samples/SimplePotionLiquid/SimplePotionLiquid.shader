...
Shader "AmplifyShaderPack/URP/SimplePotionLiquid"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Speed("Speed", Float) = 0
		_Size("Size", Float) = 0.1
		_Height("Height", Float) = 0
		_Falloff("Falloff", Float) = 0.02
		_Opacity("Opacity", Float) = 0.76
		[ASEEnd]_Color("Color", Color) = (1,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Emission = ( _Color * 0.0 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.0;
				float Occlusion = 1;
				float Alpha = saturate( ( clampResult18 * _Opacity ) ).x;
...
/*ASEBEGIN
Version=18920
303;172;1497;869;-663.6923;644.4146;1.150227;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;36;1160.622,-95.16805;Inherit;False;Constant;_EmissionIntensity;Emission Intensity;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;1738.953,-42.66977;Inherit;False;Constant;_Float0;Float 0;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;34;1576.972,8.059113;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;1628.553,-151.1207;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;22;1306.895,-258.1027;Float;False;Property;_Color;Color;5;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;42;6;34;0
ASEEND*/
//CHKSM=46C24EABA0269F102D343D7851402E2A54C60816